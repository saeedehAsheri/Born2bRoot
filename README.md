# Born2bRoot
This document  helps you understand the concepts, the purpose of the project, and exactly what you need to do step‑by‑step, including what to add to the system files for sudo, SSH, UFW, password policy, and your monitoring script.
